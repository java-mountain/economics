...
//    std::string formatRow (numberCh, '-');
    //print();
    for(size_t i = 0; i < (firstColWidth + 12); i++ ) {
        std::cout << "-";
    }
    std::cout << std::endl;
...
//    std::cout << "firstColWidth is " << firstColWidth << std::endl;
    ...
    std::cout << std::endl;
    //print();
    std::string str_chars (36, '-');
    std::cout << str_chars << std::endl;
    ...
    while(currentProfit<grossProfit)
    {
        ...
        {
          //print();
          std::string str_chars1 (41, '-');
          std::cout << str_chars1 << std::endl;
...
//    print();
    ...
    for(size_t j = 0; j < (firstColWidth + 48); j++) {
        std::cout << "-";
    }
    std::cout << std::endl;
